...
const pb_field_t Main_SystemStatus_fields[4] = {
    PB_FIELD(  1, BOOL    , OPTIONAL, STATIC  , FIRST, Main_SystemStatus, active, active, 0),
    PB_FIELD(  2, INT32   , OPTIONAL, STATIC  , OTHER, Main_SystemStatus, bootCause, active, 0),
    PB_FIELD(  3, UINT32  , OPTIONAL, STATIC  , OTHER, Main_SystemStatus, faultAddress, bootCause, 0),
    PB_LAST_FIELD
};
